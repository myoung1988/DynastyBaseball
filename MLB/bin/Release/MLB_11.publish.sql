...
GO
PRINT N'Dropping DF__Eligibili__Date___5DCAEF64...';


GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___5DCAEF64];


GO
PRINT N'Dropping DF__Eligibili__Date___5EBF139D...';


GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___5EBF139D];


GO
PRINT N'Dropping DF__Player__Date_Tim__5FB337D6...';


GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__5FB337D6];


GO
PRINT N'Dropping DF__Player__Date_Tim__60A75C0F...';


GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__60A75C0F];


GO
PRINT N'Dropping DF__Position__Date_T__619B8048...';


GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__619B8048];


GO
PRINT N'Dropping DF__Position__Date_T__628FA481...';


GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__628FA481];


GO
PRINT N'Dropping DF__Roster__Date_Tim__6383C8BA...';


GO
ALTER TABLE [dbo].[Roster] DROP CONSTRAINT [DF__Roster__Date_Tim__6383C8BA];


GO
PRINT N'Dropping DF__Roster__Date_Tim__6477ECF3...';


GO
ALTER TABLE [dbo].[Roster] DROP CONSTRAINT [DF__Roster__Date_Tim__6477ECF3];


GO
PRINT N'Dropping DF__Team__Date_Time___656C112C...';


GO
ALTER TABLE [dbo].[Team] DROP CONSTRAINT [DF__Team__Date_Time___656C112C];


GO
PRINT N'Dropping DF__Team__Date_Time___66603565...';


GO
ALTER TABLE [dbo].[Team] DROP CONSTRAINT [DF__Team__Date_Time___66603565];
