...
GO
PRINT N'Dropping DF__Eligibili__Date___18EBB532...';


GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___18EBB532];


GO
PRINT N'Dropping DF__Eligibili__Date___19DFD96B...';


GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___19DFD96B];


GO
PRINT N'Dropping DF__Fantasy_L__Date___1AD3FDA4...';


GO
ALTER TABLE [dbo].[Fantasy_League] DROP CONSTRAINT [DF__Fantasy_L__Date___1AD3FDA4];


GO
PRINT N'Dropping DF__Fantasy_L__Date___1BC821DD...';


GO
ALTER TABLE [dbo].[Fantasy_League] DROP CONSTRAINT [DF__Fantasy_L__Date___1BC821DD];


GO
PRINT N'Dropping DF__Fantasy_R__Date___1CBC4616...';


GO
ALTER TABLE [dbo].[Fantasy_Roster] DROP CONSTRAINT [DF__Fantasy_R__Date___1CBC4616];


GO
PRINT N'Dropping DF__Fantasy_R__Date___1DB06A4F...';


GO
ALTER TABLE [dbo].[Fantasy_Roster] DROP CONSTRAINT [DF__Fantasy_R__Date___1DB06A4F];


GO
PRINT N'Dropping DF__Fantasy_T__Date___1EA48E88...';


GO
ALTER TABLE [dbo].[Fantasy_Team] DROP CONSTRAINT [DF__Fantasy_T__Date___1EA48E88];


GO
PRINT N'Dropping DF__Fantasy_T__Date___1F98B2C1...';


GO
ALTER TABLE [dbo].[Fantasy_Team] DROP CONSTRAINT [DF__Fantasy_T__Date___1F98B2C1];


GO
PRINT N'Dropping DF__Player__Date_Tim__208CD6FA...';


GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__208CD6FA];


GO
PRINT N'Dropping DF__Player__Date_Tim__2180FB33...';


GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__2180FB33];


GO
PRINT N'Dropping DF__Position__Date_T__22751F6C...';


GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__22751F6C];


GO
PRINT N'Dropping DF__Position__Date_T__236943A5...';


GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__236943A5];


GO
PRINT N'Dropping DF__Team__Date_Time___245D67DE...';


GO
ALTER TABLE [dbo].[Team] DROP CONSTRAINT [DF__Team__Date_Time___245D67DE];


GO
PRINT N'Dropping DF__Team__Date_Time___25518C17...';


GO
ALTER TABLE [dbo].[Team] DROP CONSTRAINT [DF__Team__Date_Time___25518C17];
