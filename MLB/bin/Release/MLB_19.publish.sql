...
GO
PRINT N'Dropping DF__Eligibili__Date___5224328E...';


GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___5224328E];


GO
PRINT N'Dropping DF__Eligibili__Date___531856C7...';


GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___531856C7];


GO
PRINT N'Dropping DF__Fantasy_L__Date___540C7B00...';


GO
ALTER TABLE [dbo].[Fantasy_League] DROP CONSTRAINT [DF__Fantasy_L__Date___540C7B00];


GO
PRINT N'Dropping DF__Fantasy_L__Date___55009F39...';


GO
ALTER TABLE [dbo].[Fantasy_League] DROP CONSTRAINT [DF__Fantasy_L__Date___55009F39];


GO
PRINT N'Dropping DF__tmp_ms_xx__Date___6442E2C9...';


GO
ALTER TABLE [dbo].[Fantasy_Roster] DROP CONSTRAINT [DF__tmp_ms_xx__Date___6442E2C9];


GO
PRINT N'Dropping DF__tmp_ms_xx__Date___65370702...';


GO
ALTER TABLE [dbo].[Fantasy_Roster] DROP CONSTRAINT [DF__tmp_ms_xx__Date___65370702];


GO
PRINT N'Dropping DF__Fantasy_T__Date___57DD0BE4...';


GO
ALTER TABLE [dbo].[Fantasy_Team] DROP CONSTRAINT [DF__Fantasy_T__Date___57DD0BE4];


GO
PRINT N'Dropping DF__Fantasy_T__Date___58D1301D...';


GO
ALTER TABLE [dbo].[Fantasy_Team] DROP CONSTRAINT [DF__Fantasy_T__Date___58D1301D];


GO
PRINT N'Dropping DF__Player__Date_Tim__59C55456...';


GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__59C55456];


GO
PRINT N'Dropping DF__Player__Date_Tim__5AB9788F...';


GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__5AB9788F];


GO
PRINT N'Dropping DF__Position__Date_T__5BAD9CC8...';


GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__5BAD9CC8];


GO
PRINT N'Dropping DF__Position__Date_T__5CA1C101...';


GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__5CA1C101];


GO
PRINT N'Dropping DF__Team__Date_Time___5D95E53A...';


GO
ALTER TABLE [dbo].[Team] DROP CONSTRAINT [DF__Team__Date_Time___5D95E53A];


GO
PRINT N'Dropping DF__Team__Date_Time___5E8A0973...';


GO
ALTER TABLE [dbo].[Team] DROP CONSTRAINT [DF__Team__Date_Time___5E8A0973];
