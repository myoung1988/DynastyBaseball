...
GO
PRINT N'Dropping DF__Eligibili__Date___2739D489...';


GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___2739D489];


GO
PRINT N'Dropping DF__Eligibili__Date___282DF8C2...';


GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___282DF8C2];


GO
PRINT N'Dropping DF__Fantasy_L__Date___29221CFB...';


GO
ALTER TABLE [dbo].[Fantasy_League] DROP CONSTRAINT [DF__Fantasy_L__Date___29221CFB];


GO
PRINT N'Dropping DF__Fantasy_L__Date___2A164134...';


GO
ALTER TABLE [dbo].[Fantasy_League] DROP CONSTRAINT [DF__Fantasy_L__Date___2A164134];


GO
PRINT N'Dropping DF__Fantasy_R__Date___2BFE89A6...';


GO
ALTER TABLE [dbo].[Fantasy_Roster] DROP CONSTRAINT [DF__Fantasy_R__Date___2BFE89A6];


GO
PRINT N'Dropping DF__Fantasy_R__Date___2CF2ADDF...';


GO
ALTER TABLE [dbo].[Fantasy_Roster] DROP CONSTRAINT [DF__Fantasy_R__Date___2CF2ADDF];


GO
PRINT N'Dropping DF__Fantasy_T__Date___2DE6D218...';


GO
ALTER TABLE [dbo].[Fantasy_Team] DROP CONSTRAINT [DF__Fantasy_T__Date___2DE6D218];


GO
PRINT N'Dropping DF__Fantasy_T__Date___2EDAF651...';


GO
ALTER TABLE [dbo].[Fantasy_Team] DROP CONSTRAINT [DF__Fantasy_T__Date___2EDAF651];


GO
PRINT N'Dropping DF__Player__Date_Tim__2FCF1A8A...';


GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__2FCF1A8A];


GO
PRINT N'Dropping DF__Player__Date_Tim__30C33EC3...';


GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__30C33EC3];


GO
PRINT N'Dropping DF__Position__Date_T__31B762FC...';


GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__31B762FC];


GO
PRINT N'Dropping DF__Position__Date_T__32AB8735...';


GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__32AB8735];


GO
PRINT N'Dropping DF__Team__Date_Time___339FAB6E...';


GO
ALTER TABLE [dbo].[Team] DROP CONSTRAINT [DF__Team__Date_Time___339FAB6E];


GO
PRINT N'Dropping DF__Team__Date_Time___3493CFA7...';


GO
ALTER TABLE [dbo].[Team] DROP CONSTRAINT [DF__Team__Date_Time___3493CFA7];
