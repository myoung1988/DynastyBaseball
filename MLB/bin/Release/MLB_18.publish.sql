...
GO
PRINT N'Dropping DF__Eligibili__Date___43D61337...';


GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___43D61337];


GO
PRINT N'Dropping DF__Eligibili__Date___44CA3770...';


GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___44CA3770];


GO
PRINT N'Dropping DF__Fantasy_L__Date___45BE5BA9...';


GO
ALTER TABLE [dbo].[Fantasy_League] DROP CONSTRAINT [DF__Fantasy_L__Date___45BE5BA9];


GO
PRINT N'Dropping DF__Fantasy_L__Date___46B27FE2...';


GO
ALTER TABLE [dbo].[Fantasy_League] DROP CONSTRAINT [DF__Fantasy_L__Date___46B27FE2];


GO
PRINT N'Dropping DF__Fantasy_R__Date___47A6A41B...';


GO
ALTER TABLE [dbo].[Fantasy_Roster] DROP CONSTRAINT [DF__Fantasy_R__Date___47A6A41B];


GO
PRINT N'Dropping DF__Fantasy_R__Date___489AC854...';


GO
ALTER TABLE [dbo].[Fantasy_Roster] DROP CONSTRAINT [DF__Fantasy_R__Date___489AC854];


GO
PRINT N'Dropping DF__Fantasy_T__Date___498EEC8D...';


GO
ALTER TABLE [dbo].[Fantasy_Team] DROP CONSTRAINT [DF__Fantasy_T__Date___498EEC8D];


GO
PRINT N'Dropping DF__Fantasy_T__Date___4A8310C6...';


GO
ALTER TABLE [dbo].[Fantasy_Team] DROP CONSTRAINT [DF__Fantasy_T__Date___4A8310C6];


GO
PRINT N'Dropping DF__Player__Date_Tim__4B7734FF...';


GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__4B7734FF];
...
GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__4C6B5938];


GO
PRINT N'Dropping DF__Position__Date_T__4D5F7D71...';


GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__4D5F7D71];
...
GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__4E53A1AA];


GO
PRINT N'Dropping DF__Team__Date_Time___4F47C5E3...';


GO
ALTER TABLE [dbo].[Team] DROP CONSTRAINT [DF__Team__Date_Time___4F47C5E3];


GO
PRINT N'Dropping DF__Team__Date_Time___503BEA1C...';


GO
ALTER TABLE [dbo].[Team] DROP CONSTRAINT [DF__Team__Date_Time___503BEA1C];
