...
GO
PRINT N'Dropping DF__Eligibili__Date___367C1819...';


GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___367C1819];


GO
PRINT N'Dropping DF__Eligibili__Date___37703C52...';


GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___37703C52];


GO
PRINT N'Dropping DF__Fantasy_L__Date___3864608B...';


GO
ALTER TABLE [dbo].[Fantasy_League] DROP CONSTRAINT [DF__Fantasy_L__Date___3864608B];


GO
PRINT N'Dropping DF__Fantasy_L__Date___395884C4...';


GO
ALTER TABLE [dbo].[Fantasy_League] DROP CONSTRAINT [DF__Fantasy_L__Date___395884C4];


GO
PRINT N'Dropping DF__Fantasy_R__Date___3A4CA8FD...';


GO
ALTER TABLE [dbo].[Fantasy_Roster] DROP CONSTRAINT [DF__Fantasy_R__Date___3A4CA8FD];


GO
PRINT N'Dropping DF__Fantasy_R__Date___3B40CD36...';


GO
ALTER TABLE [dbo].[Fantasy_Roster] DROP CONSTRAINT [DF__Fantasy_R__Date___3B40CD36];


GO
PRINT N'Dropping DF__Fantasy_T__Date___3C34F16F...';


GO
ALTER TABLE [dbo].[Fantasy_Team] DROP CONSTRAINT [DF__Fantasy_T__Date___3C34F16F];


GO
PRINT N'Dropping DF__Fantasy_T__Date___3D2915A8...';


GO
ALTER TABLE [dbo].[Fantasy_Team] DROP CONSTRAINT [DF__Fantasy_T__Date___3D2915A8];


GO
PRINT N'Dropping DF__Player__Date_Tim__3E1D39E1...';


GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__3E1D39E1];


GO
PRINT N'Dropping DF__Player__Date_Tim__3F115E1A...';


GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__3F115E1A];


GO
PRINT N'Dropping DF__Position__Date_T__40058253...';


GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__40058253];


GO
PRINT N'Dropping DF__Position__Date_T__40F9A68C...';


GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__40F9A68C];


GO
PRINT N'Dropping DF__Team__Date_Time___41EDCAC5...';


GO
ALTER TABLE [dbo].[Team] DROP CONSTRAINT [DF__Team__Date_Time___41EDCAC5];


GO
PRINT N'Dropping DF__Team__Date_Time___42E1EEFE...';


GO
ALTER TABLE [dbo].[Team] DROP CONSTRAINT [DF__Team__Date_Time___42E1EEFE];
...
GO
ALTER TABLE [dbo].[Fantasy_Roster] WITH CHECK CHECK CONSTRAINT [CK_Fantasy_Roster_Status];
