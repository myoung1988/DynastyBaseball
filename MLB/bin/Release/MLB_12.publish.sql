...
GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___6754599E];
...
GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___68487DD7];


GO
PRINT N'Dropping DF__Player__Date_Tim__693CA210...';


GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__693CA210];


GO
PRINT N'Dropping DF__Player__Date_Tim__6A30C649...';


GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__6A30C649];


GO
PRINT N'Dropping DF__Position__Date_T__6B24EA82...';


GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__6B24EA82];


GO
PRINT N'Dropping DF__Position__Date_T__6C190EBB...';


GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__6C190EBB];


GO
PRINT N'Dropping DF__Team__Date_Time___6EF57B66...';


GO
ALTER TABLE [dbo].[Team] DROP CONSTRAINT [DF__Team__Date_Time___6EF57B66];


GO
PRINT N'Dropping DF__Team__Date_Time___6FE99F9F...';


GO
ALTER TABLE [dbo].[Team] DROP CONSTRAINT [DF__Team__Date_Time___6FE99F9F];


GO
PRINT N'Creating [dbo].[Fantasy_League]...';
...
GO
PRINT N'Creating [dbo].[Fantasy_Roster]...';
...
GO
PRINT N'Creating [dbo].[Fantasy_Team]...';
...
GO
ALTER TABLE [dbo].[Fantasy_League] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[Fantasy_League] WITH CHECK CHECK CONSTRAINT [CK_Fantasy_League_LeagueType];
