...
GO
PRINT N'The following operation was generated from a refactoring log file de64296c-195f-4ddb-ba0b-d935aa3ef404';

PRINT N'Rename [dbo].[Status_CK] to Fantasy_Roster_Status_CK';


GO
EXECUTE sp_rename @objname = N'[dbo].[Status_CK]', @newname = N'Fantasy_Roster_Status_CK', @objtype = N'OBJECT';


GO
PRINT N'Dropping DF__Eligibili__Date___0A9D95DB...';


GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___0A9D95DB];


GO
PRINT N'Dropping DF__Eligibili__Date___0B91BA14...';


GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___0B91BA14];


GO
PRINT N'Dropping DF__Fantasy_L__Date___0C85DE4D...';


GO
ALTER TABLE [dbo].[Fantasy_League] DROP CONSTRAINT [DF__Fantasy_L__Date___0C85DE4D];


GO
PRINT N'Dropping DF__Fantasy_L__Date___0D7A0286...';


GO
ALTER TABLE [dbo].[Fantasy_League] DROP CONSTRAINT [DF__Fantasy_L__Date___0D7A0286];


GO
PRINT N'Dropping DF__Fantasy_R__Date___0E6E26BF...';


GO
ALTER TABLE [dbo].[Fantasy_Roster] DROP CONSTRAINT [DF__Fantasy_R__Date___0E6E26BF];


GO
PRINT N'Dropping DF__Fantasy_R__Date___0F624AF8...';


GO
ALTER TABLE [dbo].[Fantasy_Roster] DROP CONSTRAINT [DF__Fantasy_R__Date___0F624AF8];


GO
PRINT N'Dropping DF__Fantasy_T__Date___10566F31...';


GO
ALTER TABLE [dbo].[Fantasy_Team] DROP CONSTRAINT [DF__Fantasy_T__Date___10566F31];


GO
PRINT N'Dropping DF__Fantasy_T__Date___114A936A...';


GO
ALTER TABLE [dbo].[Fantasy_Team] DROP CONSTRAINT [DF__Fantasy_T__Date___114A936A];


GO
PRINT N'Dropping DF__Player__Date_Tim__123EB7A3...';


GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__123EB7A3];


GO
PRINT N'Dropping DF__Player__Date_Tim__1332DBDC...';


GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__1332DBDC];


GO
PRINT N'Dropping DF__Position__Date_T__14270015...';


GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__14270015];


GO
PRINT N'Dropping DF__Position__Date_T__151B244E...';


GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__151B244E];


GO
PRINT N'Dropping DF__Team__Date_Time___160F4887...';


GO
ALTER TABLE [dbo].[Team] DROP CONSTRAINT [DF__Team__Date_Time___160F4887];


GO
PRINT N'Dropping DF__Team__Date_Time___17036CC0...';


GO
ALTER TABLE [dbo].[Team] DROP CONSTRAINT [DF__Team__Date_Time___17036CC0];
...
GO
PRINT N'Creating Fantasy_Roster_Status_CK...';


GO
ALTER TABLE [dbo].[Fantasy_Roster] WITH NOCHECK
    ADD CONSTRAINT [Fantasy_Roster_Status_CK] CHECK (Status = 'A' OR Status = 'R' OR Status = 'I' OR Status = 'M');
...
GO
ALTER TABLE [dbo].[Fantasy_Roster] WITH CHECK CHECK CONSTRAINT [Fantasy_Roster_Status_CK];
