...
GO
PRINT N'Dropping DF__Eligibili__Date___5165187F...';


GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___5165187F];


GO
PRINT N'Dropping DF__Eligibili__Date___52593CB8...';


GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___52593CB8];


GO
PRINT N'Dropping DF__Player__Date_Tim__534D60F1...';


GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__534D60F1];
...
GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__5441852A];


GO
PRINT N'Dropping DF__Position__Date_T__5535A963...';


GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__5535A963];
...
GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__5629CD9C];


GO
PRINT N'Dropping DF__Roster__Date_Tim__571DF1D5...';


GO
ALTER TABLE [dbo].[Roster] DROP CONSTRAINT [DF__Roster__Date_Tim__571DF1D5];


GO
PRINT N'Dropping DF__Roster__Date_Tim__5812160E...';


GO
ALTER TABLE [dbo].[Roster] DROP CONSTRAINT [DF__Roster__Date_Tim__5812160E];
