...
GO
PRINT N'Dropping DF__Eligibili__Date___01142BA1...';


GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___01142BA1];


GO
PRINT N'Dropping DF__Eligibili__Date___02084FDA...';


GO
ALTER TABLE [dbo].[Eligibility] DROP CONSTRAINT [DF__Eligibili__Date___02084FDA];


GO
PRINT N'Dropping DF__Fantasy_L__Date___7B5B524B...';


GO
ALTER TABLE [dbo].[Fantasy_League] DROP CONSTRAINT [DF__Fantasy_L__Date___7B5B524B];


GO
PRINT N'Dropping DF__Fantasy_L__Date___7C4F7684...';


GO
ALTER TABLE [dbo].[Fantasy_League] DROP CONSTRAINT [DF__Fantasy_L__Date___7C4F7684];


GO
PRINT N'Dropping DF__Fantasy_R__Date___7D439ABD...';


GO
ALTER TABLE [dbo].[Fantasy_Roster] DROP CONSTRAINT [DF__Fantasy_R__Date___7D439ABD];


GO
PRINT N'Dropping DF__Fantasy_R__Date___7E37BEF6...';


GO
ALTER TABLE [dbo].[Fantasy_Roster] DROP CONSTRAINT [DF__Fantasy_R__Date___7E37BEF6];


GO
PRINT N'Dropping DF__Fantasy_T__Date___00200768...';


GO
ALTER TABLE [dbo].[Fantasy_Team] DROP CONSTRAINT [DF__Fantasy_T__Date___00200768];


GO
PRINT N'Dropping DF__Fantasy_T__Date___7F2BE32F...';


GO
ALTER TABLE [dbo].[Fantasy_Team] DROP CONSTRAINT [DF__Fantasy_T__Date___7F2BE32F];


GO
PRINT N'Dropping DF__Player__Date_Tim__02FC7413...';


GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__02FC7413];


GO
PRINT N'Dropping DF__Player__Date_Tim__03F0984C...';


GO
ALTER TABLE [dbo].[Player] DROP CONSTRAINT [DF__Player__Date_Tim__03F0984C];


GO
PRINT N'Dropping DF__Position__Date_T__04E4BC85...';


GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__04E4BC85];


GO
PRINT N'Dropping DF__Position__Date_T__05D8E0BE...';


GO
ALTER TABLE [dbo].[Position] DROP CONSTRAINT [DF__Position__Date_T__05D8E0BE];


GO
PRINT N'Dropping DF__Team__Date_Time___06CD04F7...';


GO
ALTER TABLE [dbo].[Team] DROP CONSTRAINT [DF__Team__Date_Time___06CD04F7];


GO
PRINT N'Dropping DF__Team__Date_Time___07C12930...';


GO
ALTER TABLE [dbo].[Team] DROP CONSTRAINT [DF__Team__Date_Time___07C12930];
...
GO
ALTER TABLE [dbo].[Fantasy_Roster] WITH CHECK CHECK CONSTRAINT [Status_CK];
